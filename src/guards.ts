 ...
 * Returns true if the object is an array of any type, otherwise false.
 */
 ...
 *
 * @return {boolean}
 * Returns true if obj is a number and not NaN, false otherwise.
 */
 ...
 *
 * @return {boolean}
 * Returns true if the input object is a function, otherwise false.
 */
 ...
 * The object to check.
 *
 * @return {obj is Record<never, never>}
